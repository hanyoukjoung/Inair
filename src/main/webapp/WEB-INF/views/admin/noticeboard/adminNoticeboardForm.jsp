		         		 ...
		         		 <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
		            		<h5>공지사항 등록</h5>
					          ...
					          <div class="widget-content nopadding">
						            <form name="insertNoticeboard" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
							              <div class="control-group">
							                <label class="control-label">아이디 :</label>
								                <div class="controls">
								                 	<label class="control-label">${LOGIN_ADMININFO.admin_id}</label>
								                </div>
							              </div>
							              <div class="control-group">
							                <label class="control-label">제목 :</label>
								                <div class="controls">
								                 	 <input type="text" id="notice_sj" name="notice_sj" class="span11" placeholder="제목" />
								               		 <input type="hidden" id="admin_id" name="admin_id" value="${LOGIN_ADMININFO.admin_id}"/>
								                </div>
							              </div>
							                <div class="control-group">
							              ...
							              <div class="form-actions">
							                	...
							                	<button type="submit" class="btn btn-success" style="margin-left:90%">Save</button>
							              </div>
						            </form>
