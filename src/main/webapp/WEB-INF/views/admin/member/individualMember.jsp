...
<script type="text/javascript">
	...
	$(function(){
		...
		$('tr .indvdlTableTd').click(function(){
			...
			individualMemberViewForm.setAttribute("action", "${adminMemberManagementURL}/individualMemberViewForm.do"); 
...
<body>
	<div id="content">
	  <div id="content-header">
	    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>회원관리</a> <a href="#" class="current">개인회원관리</a> </div>
	    <h1>개인회원관리</h1>
	  </div>
			              	...
			              	<c:if test="${!empty indvdlMemList}">
				              	<c:forEach items="${indvdlMemList}" var="indvdlMemInfo">
					                <tr class="gradeX">
					                  ...
					                  <td class="indvdlTableTd">${indvdlMemInfo.indvdl_adres1}</td>
					                  <td class="center indvdlTableTd">${indvdlMemInfo.indvdl_gend}</td>
					                </tr>
				                </c:forEach>
			                </c:if>
			              </tbody>
