...
<body>
	<div class="row-fluid">
	  <div id="footer" class="span12"> 2012 &copy; Marutii Admin. Brought to you by <a href="#">inAIR</a> </div>
	</div>
	<script src="${pageContext.request.contextPath}/js/commons.js"></script>
	


	<script src="${pageContext.request.contextPath}/bootstrap2/js/jquery.uniform.js"></script> 
	<script src="${pageContext.request.contextPath}/bootstrap2/js/select2.min.js"></script> 
	<script src="${pageContext.request.contextPath}/bootstrap2/js/jquery.dataTables.min.js"></script> 
	<script src="${pageContext.request.contextPath}/bootstrap2/js/maruti.tables.js"></script>
