...
<head>
    ...
    <body>
        <div id="loginbox">          
            <form name="idsearch" id="idsearch"action="${pageContext.request.contextPath }/individualMember/login/emailSend.do" style="background-color:white">
				<p class="normal_text">e-로움 아이디를 잊어버리셨나요?</p>
				
                    <div class="controls">
                        <div class="main_input_box">
                        	<input type="text" placeholder="이름" id="indvdl_name" name="indvdl_name"/></br>

                            <input type="email" placeholder="회원가입할때 입력하신 이메일 주소를 입력해주세요" id="indvdl_mail" name="indvdl_mail"/>
                ...
                <div class="form-actions">
                    <span class="pull-left"><a href="${pageContext.request.contextPath}/login/loginForm.do" class="flip-link btn btn-inverse" id="to-login">&laquo; Back to login</a></span>
                      <span class="pull-left"><input onclick="location.href='${pageContext.request.contextPath }/individualMember/login/passSearch.do' " type="button" class="btn btn-info" value="비밀번호찾기" style="margin-left:10px;"/></span>
