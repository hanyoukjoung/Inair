		...
		<div class="container">
			<div class="col-md-13 order-md-last d-flex" style="clear:both;">
				<div class="bg-white p-5 contact-form" id="personalData" style="width:100%;">
					...
					<br>
					<div>
						<b style="font-size: 25px;">${com_id}님</b> <b style="font-size: 25px; color: #35829c">inAIR 탈퇴</b><span style="font-size: 25px;">가 완료되었습니다.</span>
						<p>그동안 inAIR을 사랑해주신 <b>회원님</b>께 깊은 감사 드리며, 다시 뵙게 되는 그날에는 더 나은 서비스로 보답하겠습니다.</p>
						<p>inAIR은 구직자 모두가 취업에 성공하는 그날까지 더욱더 노력하겠습니다.</p>
						<p>감사합니다.</p>
					</div>
					<br><br>
