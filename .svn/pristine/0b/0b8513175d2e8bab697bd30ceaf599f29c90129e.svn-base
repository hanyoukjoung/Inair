...
<body>
	<section class="ftco-section bg-light" style="margin-left:20%;width:70%">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 pr-lg-4">
					...
					<div class="row">
						<c:forEach items="${mentorList}" var="mentorInfo">
							<div class="col-md-12 ftco-animate" id="mentorTable" onclick="mentorView(${mentorInfo.mentor_num},${mentorInfo.mentor_group});">
	...
	<div>
		<c:if test="${!empty LOGIN_INDVDLMEMINFO.indvdl_id}">
			<button type="button" id="btnform" class="btn btn-primary py-2" style="margin-left: 78%">게시글 등록</button>
		  	...
		  	<form name="searchForm" action="/mentorboard/mentorboardHome.do" method="post" class="search-job" style="width: 25%;margin-left: 59%;margin-top: 1%">
      ...
      <section style="margin-top:5%;margin-left:10%">
    	<div class="container">
    		<div class="row">
    			<div class="col-md-12">
