...
public interface IINDVDLMEMDao {
	
	/**
	 * INDVDLMEMVO를 id와 pass를 받아서 해당하는 회원정보를 리턴하는 매서드
	 * @date 2020-04-29
	 * @author 한유경
	 * @param params
	 * @return 파라미터로 받은 id와 pass에 해당하는 INDVDLMEMVO
	 * @throws Exception
	 */
	public INDVDLMEMVO indvdlmemInfo(Map<String, String> params) throws Exception;
	
	/**
	 * INDVDLMEMVO를 name와 mail을 받아서 해당하는 회원정보를 리턴하는 매서드 
	 * @date 2020-05-01
	 * @author 한유경
	 * @param params
	 * @return 파라미터로 받은 name와 mail애 해당하는 INDVDLMEMVO
	 * @throws Exception
	 */
	public INDVDLMEMVO searchid(Map<String, String> params) throws Exception;
	
	/**
	 * id와 email을 받아서 해당하는 INDVDLMEMVO를 리턴하는 매서드 
	 * @date 2020-05-02
	 * @author 한유경
	 * @param params
	 * @return 파라미터로 받은 id와 email에 해당하는 INDVDLMEMVO를 리턴하는 매서드
	 * @throws Exception
	 */
	public INDVDLMEMVO searchpass(Map<String, String> param) throws Exception;
	
	/**
	 * id와 임시패스워드를 params로 받아서 update시켜주는 매서드
	 * @date 2020-05-02
	 * @author 한유경
	 * @param params
	 * @throws Exception
