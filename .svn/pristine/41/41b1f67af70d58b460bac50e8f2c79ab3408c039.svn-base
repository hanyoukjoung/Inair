...
<div class="container">
  <h4>메일 보내기</h4>
  <form action="${pageContext.request.contextPath}/mail/navermailtest.do" method="post">
    ...
    <div align="center">
      <input type="submit" value="메일 보내기" class="btn btn-warning">
        <input type="button"  onclick="location.href='${pageContext.request.contextPath}/mail/navermailtest.do' " value="메일 보내기2" class="btn btn-warning">
    </div>
  </form>
</div>
</body>
